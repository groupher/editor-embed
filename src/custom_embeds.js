...
export const  customIframeFragment = (url) => {
  ...
  switch(domain) {
    case 'amap': {
      ...
      const html = `<iframe sandbox="allow-scripts allow-presentation" src="${mapSrc}" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen="" style="width: 100%; height: 300px;"></iframe>`
    ...
    case 'bilibili': {
      ...
      const html = `<iframe id=${fid} sandbox="allow-scripts allow-same-origin allow-popups allow-presentation" src="${src}" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen="" style="width: 100%; height: 381.938px; max-width: 730px; max-height: 410.625px;"></iframe>`

      return { valid: true, html, fid }
    }
    default: {
